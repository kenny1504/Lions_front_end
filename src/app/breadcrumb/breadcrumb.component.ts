...
export class BreadcrumbComponent implements OnInit {
  ...
  filterNavigation(activeLink: string) {
    let result: any[] = [];
    let title = 'Welcome';
    this.navigation.forEach((a: { type: string; url: string; title: string; breadcrumbs: any; children: any[]; }) => {
          ...
          a.children.forEach((b) => {
            if (b.type === 'item' && 'url' in b && b.url === activeLink) {
              ...
              if (b.type === 'collapse' && 'children' in b) {
                b.children.forEach((c: { type: string; url: string; title: string; breadcrumbs: any; children: any[]; }) => {
    ...
    this.titleService.setTitle(title + ' | Lion\'s Barbershop');
  }
